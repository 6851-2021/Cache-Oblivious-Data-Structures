...
test_CA_SST: static-search-trees.h static-search-trees.cpp ca_static_search_trees_tests.cpp
...
perf: static-search-trees.h static-search-trees.cpp perf_sst.cpp perf_co_sst.cpp perf_params.h
	g++ -O3 -g -flto -o perf_sst static-search-trees.cpp perf_sst.cpp
	g++ -O3 -g -flto -o perf_co_sst static-search-trees.cpp perf_co_sst.cpp
